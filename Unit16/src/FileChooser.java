  ...
  public static String getMediaDirectory() 
  {
    ...
    // try to find the images directory
      try {
        ...
        java.net.URL classURL = currClass.getResource("FileChooser.class");
        URL fileURL = new URL("C:\\Users\\ivpizzi\\Documents\\GitHub\\pizzi_isabella_apcsa-p3\\Unit16\\src\\images");
        directory = ((File) fileURL).getPath();
